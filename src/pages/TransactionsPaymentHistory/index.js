...
import { Row, Title, IconButton, OptionsMenu } from '../../components/common'
...
const TransactionsPaymentHistory = () => {
    ...
    const { data: transactionHistory, isLoading: isTransactionHistoryLoading, } = useGetTransactionsHistoryQuery()
    ...
    return (
        <>
            ...
            <Row
                ...
                <Title fontWeight='650' fontSize='20px'>Payment History</Title>
            </Row>
            {/* <Table>
                <thead>
                    <TableHeadRow>
