...
import { Row, Title, IconButton, Paragraph } from '../../components/common'
    ...
    const data = [
        {
            ...
            summary: 'From Uk and willing to move on to other country for making name industry',
            time: '10:48 pm'
        },
        {
        ...
        },
        {
            ...
            summary: 'From Uk and willing to move on to other country for making name industryLeo orge Marker paul ',
            time: '10:48 pm'
        }
    ]
    return (
                        ...
                        return (
                            <>
                                ...
                                >
                                    ...
                                    <Grid item lg={2.3}>
                                        <Paragraph textAlign='justify' color='black' fontSize='20px'>{item.name}</Paragraph>
                                    </Grid>
                                    <Grid item lg={8.5}>
                                        <Paragraph textAlign='justify' color='black' width='100%' fontSize='20px'>{item.summary}</Paragraph>
                                    </Grid>
                                    <Grid item lg={0.5}>
                                        <Paragraph width='100%' textAlign='justify' fontSize='12px'>{item.time}</Paragraph>
                                    </Grid>
                                </Grid>
                                <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.03)', width: '100%', height: '2px' }} />
                            </>
                        )
                    })}
                </NotificationContainer>
