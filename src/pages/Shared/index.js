...
import { Button, IconButton, OptionsMenu, Row, Title } from "../../components/common"
import {
  Table,
  TableHeadRow,
  TableBodyRow
...
export default function Shared() {
  ...
  const array =
    [
      { name: 'adlkfj', share: 'askflhakls', size: '10mb', email: 'abs@gamil.com' },
      { name: 'adlkfj', share: 'askflhakls', size: '10mb', email: 'abs@gamil.com' },
      { name: 'adlkfj', share: 'askflhakls', size: '10mb', email: 'abs@gamil.com' },
      { name: 'adlkfj', share: 'askflhakls', size: '10mb', email: 'abs@gamil.com' },
      { name: 'adlkfj', share: 'askflhakls', size: '10mb', email: 'abs@gamil.com' },
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        <Row style={{ width: '76%', height: 'fit-content' }}>
            ...
            <tbody>
              {
                array.map((items, index) => {
                  return (
                    <TableBodyRow share={index === border} shared='shared' onClick={() => { setBorder(index); setShowShared(true) }}>
        ...
        {Boolean(showShared) && <Row style={{ width: '22%' }}>
