...
import { Row, Title, IconButton, InputGroup, Label, Button } from '../../components/common'
    ...
    <>
      ...
      >
        <Row alignItems="center">
          <MdKeyboardBackspace style={{ cursor: 'pointer' }} onClick={() => navigate(-1)} size={25} />
          <Title fontWeight='650' margin='0px 0px 0px 40px'>My Transactions</Title>
        </Row>
        <Row>
          <OptionMenuSettings
            options={[
      ...
      <div style={{ padding: '0px 40px' }}>
        <Row
          ...
          <Title fontWeight='650' fontSize='20px'>Add Payment Method</Title>
        </Row>
        <form onSubmit={handleSubmit}>
          ...
          <Row justifyContent="space-between">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', margin: '8px 0' }}>
              ...
              <div id="card-number-container" style={{ display: 'flex', alignItems: 'center', marginTop: 8, border: '1px solid', borderColor: '#292D3233', borderRadius: 10, backgroundColor: '#fff', padding: '0 14px', width: 512, height: 75 }}>
                <div style={{ width: '100%' }}>
                  <CardNumberElement
                    onFocus={() => {
          ...
          <Row justifyContent="space-between">
            ...
            />
            <Row width="50%" padding="0px 20px" justifyContent="space-between">
              <div style={{ display: 'flex', flexDirection: 'column', margin: '8px 0', width: '48.5%' }}>
                <Label>Card Expiration Date </Label>
                <div id="card-expiry-container" style={{ display: 'flex', alignItems: 'center', marginTop: 8, border: "solid 1px #292D3233", borderRadius: 10, backgroundColor: '#fff', padding: '0 14px', height: 75 }}>
                  <div style={{ width: '100%' }}>
                    <CardExpiryElement
                      onFocus={() => {
              ...
              <div style={{ display: 'flex', flexDirection: 'column', margin: '8px 0', width: '48.5%' }}>
                <Label>CVC</Label>
                <div id="card-cvc-container" style={{ display: 'flex', alignItems: 'center', marginTop: 8, border: "solid 1px #292D3233", borderRadius: 10, backgroundColor: '#fff', padding: '0 14px', height: 75 }}>
                  <div style={{ width: '100%' }}>
                    <CardCvcElement
                      onFocus={() => {
